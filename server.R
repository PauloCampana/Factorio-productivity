...
tabledata <- data.frame(
    Item = data()[ ,1],
    Tier3 = (
        (module$cost3[data()[ ,5]] + input$beacon * (module$cost3[2] + 337) + (data()[ ,4] == 1.25) * 389.6) *
        data()[ ,3] / data()[ ,2] /
        (data()[ ,4] * (1 + module$penalty3[data()[ ,5]] + input$beacon * module$speed[3])) /
        (1 - 1 / module$prod3[data()[ ,5]])
    ) |> round(digits = 0),
    Tier2 = (
        (module$cost2[data()[ ,5]] + input$beacon * (module$cost2[2] + 337) + (data()[ ,4] == 1.25) * 389.6) *
        data()[ ,3] / data()[ ,2] /
        (data()[ ,4] * (1 + module$penalty2[data()[ ,5]] + input$beacon * module$speed[2])) /
        (1 - 1 / module$prod2[data()[ ,5]])
    ) |> round(digits = 0),
    Tier1 = (
        (module$cost1[data()[ ,5]] + input$beacon * (module$cost1[2] + 337) + (data()[ ,4] == 1.25) * 389.6) *
        data()[ ,3] / data()[ ,2] /
